...
Every transaction consumes your $GMEX:
  ...
  5% transferred to treasury wallet (denominated in BNB)
...
contract Token is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private _previousLiquidityFee = _treasuryfee;
    ...
    event settreasuryFeePercent(uint256 fee);
    ...
    constructor(address payable treasuryWalletAddress) public {
         require(
            ...
            "treasuryWallet is zero address"
        );
    ...
    function _settreasuryFeePercent(uint256 liquidityFee) external onlyOwner {
        _treasuryfee = liquidityFee;
        emit settreasuryFeePercent(liquidityFee);
    }
    ...
    {
        (uint256 tTransferAmount, uint256 tFee, uint256 ttreasury) = _getTValues(
            tAmount
        );
    ...
    function removeAllFee() private {
        ...
        _previousLiquidityFee = _treasuryfee;
    ...
    function restoreAllFee() private {
        ...
        _treasuryfee = _previousLiquidityFee;
    }
        ...
        onlyOwner
    {
        require(
            treasuryWalletAddress != address(0),
            "new treasuryWallet is the zero address"
        );
        _treasuryWalletAddress = treasuryWalletAddress;
        emit settreasuryWallet(treasuryWalletAddress);
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        sendBNBTotreasury(contractTokenBalance);
